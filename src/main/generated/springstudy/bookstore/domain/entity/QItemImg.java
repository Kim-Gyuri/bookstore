...
public class QItemImg extends EntityPathBase<ItemImg> {
    ...
    private static final long serialVersionUID = -432027897L;
    ...
    public final EnumPath<springstudy.bookstore.domain.enums.IsMainImg> isMainImg = createEnum("isMainImg", springstudy.bookstore.domain.enums.IsMainImg.class);
